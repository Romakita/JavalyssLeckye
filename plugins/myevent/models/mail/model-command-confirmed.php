<?php
/*
Model Name: E-mail de confirmation de commande
	...
	<td style="background:rgb(255,255,255)">
		...
		<td style="text-align:left;color:rgb(67,71,76);font-family:arial,helvetica,sans-serif;font-size:12px;line-height:20px">
			<br>
            	...
            	<p>Votre commande vient d'être acceptée et est en cours de préparation.</p>
                ...
                <p><strong>Commande N° :</strong> <?php echo MyEventCommand::NB(); ?> passée le <?php echo MyEventCommand::DateCreate('%A %e %B %Y %H:%M'); ?></p>
