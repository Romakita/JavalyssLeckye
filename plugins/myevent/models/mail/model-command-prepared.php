...
<td style="text-align:left;color:#D24726;font-family:arial,helvetica,sans-serif; background:#F6F6F6;padding:5px 10px;">
    ...
    <span style="font-size:12pt;">
        ...
        Historique de la commande N° <?php echo MyEventCommand::NB(); ?>
...
<tbody>
	...
	<td style="background:rgb(255,255,255)">
		...
		<td style="text-align:left;color:rgb(67,71,76);font-family:arial,helvetica,sans-serif;font-size:12px;line-height:20px">
			<br>
				<p>Bonjour <?php $user = MyEventCommand::GetUser(); echo $user->Name . ' ' . $user->FirstName ?>,</p>
                
           		<p><strong>Votre commande est préparée et est en attente de livraison.</strong></p>
                
                <p>Si vous avez choisi de récupérer votre commande dans nos entrepôts, vous pouvez venir le récupérer dès maintenant !</p>
                <p>Sinon un second e-mail vous sera envoyé avec le lien vous permettant le suivi de votre commande.</p>   
...
<p style="color:#999; font-size:10px">Modèle généré par MyEvent !</p>
<br>
<br>
</div>