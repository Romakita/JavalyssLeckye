 ...
 *
 **/
abstract class MyStoreAccount extends ObjectTools{
/**
 *
 **/
	public static function Initialize(){
		...
		include('class_account_command.php');
		
		//on observe l'evenement mystore:start pour lancer la gestion du front office client
		System::Observe('mystore:startpage', array(__CLASS__, 'onStart')); 
		System::Observe('mystore:startpage', array(__CLASS__, 'onStartPage')); 
		System::Observe('mystore:form.submit', array(__CLASS__, 'onSubmit')); 
		System::Observe('mystore:form.before', array(__CLASS__, 'onBeforeForm'));
 ...
 **/	
	public static function onStart(){
		...
		Blog::EnqueueScript('mystore.account.info', MYSTORE_URI.'inc/account/class_account_info.js');
		Blog::EnqueueScript('mystore.account.address', MYSTORE_URI.'inc/account/class_account_address.js');
	}
/**
	...
	public static function onStartPage(){
		...
		switch(Post::Name()){
			...
			case 'compte/adresse-livraison':
				MyStoreAccountAddress::Draw();
				break;
			
			case 'compte/commandes':
				MyStoreAccountCommand::Draw();
				break;
		}		
	}
/**
...
/**
 * MyStoreAccount.onBeforeForm() -> void
 *
 * Cette méthode génère le contenu de la page.
 **/	
	public static function onBeforeForm($op){
		...
		switch($op){
			...
			case 'mystore.account.address':
				MyStoreAccountAddress::onBeforeForm();			
				break;
		}		
	}
/**
 ...
 **/	
	public static function Draw(){
		...
		?>
        <div class="mystore-dashboard">
        
            <h3>Bonjour <?php MyStore::Info('user') ?></h3>
            
            <ul class="mystore-account-nav">
            	
                <li class="command">
                    <h3><a href="<?php MyStore::Info('command') ?>"><span class="title"><?php echo MUI('Mes commandes') ?></span> <span>»</span></a></h3>
                    <p><?php echo MUI('Suivez vos commandes en cours et consultez votre historique'); ?></p>
                </li>
                
                <li class="myinfo">
                    <h3><a href="<?php MyStore::Info('myinfo') ?>"><span class="title"><?php echo MUI('Mes informations') ?></span> <span>»</span></a></h3>
                    <p><?php echo MUI('Modifiez votre nom, votre adresse e-mail ou votre mot de passe'); ?></p>
                </li>
                
                <li class="address">
                    <h3><a href="<?php MyStore::Info('address') ?>"><span class="title"><?php echo MUI('Mes adresses de livraison'); ?></span> <span>»</span></a></h3>
                    <p><?php echo MUI('Gérez vos adresses'); ?></p>
                </li>
                
                <li class="share">
                    <h3><a href="<?php MyStore::Info('cashback') ?>"><span class="title"><?php echo MUI('Mes filleul(e)s'); ?></span> <span>»</span></a></h3>
...
/*
 * MyStoreAccount.onSubmitInfo() -> void
 **/	
...
/*
 * MyStoreAccount.onBeforeFormInfo() -> void
 **/
...
/**
 * MyStoreAccount.DrawMyInfo() -> void
 *
 ...
 **/	
	public static function DrawMyInfo(){
		...
		?>
        <div class="col2-set mystore-account-info">
            ...
            <div class="col-2">
                <form action="<?php Blog::Info('submit'); ?>" method="post" name="formInfo" class="form form-account-info">
                    <input type="hidden" name="cmd" value="mystore.account.submit" />
