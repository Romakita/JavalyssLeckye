 ...
 * * Fichier : class_mystore_product_critere.php.php
 * * Note :	This work is licensed under a Creative Commons Attribution 2.5 Generic License http://creativecommons.org/licenses/by/2.5/
 *
 **/
class MyStoreProductCritere extends ObjectTools{	
	const PRE_OP =				'mystore.product.critere.';
/**
 * MyStoreProductCritere.TABLE_NAME -> String
 * Nom de la table gérée par la classe.
 **/
	const TABLE_NAME = 			'mystore_products_criteres';	
/**
 * MyStoreProductCritere.PRIMARY_KEY -> String
 * Clef primaire de la table MyStoreProductCritere.TABLE_NAME gérée par la classe.
 **/	
	const PRIMARY_KEY = 		'Critere_ID';

/**
 * MyStoreProductCritere#Critere_ID -> Number
 **/
	public $Critere_ID = 0;
/**
 * MyStoreProductCritere#Post_ID -> Number
 **/
	public $Post_ID = 0;
/**
 * MyStoreProductCritere#Name -> String
 * Varchar
 **/
	public $Name = "";
/**
 * MyStoreProductCritere#Type -> String
 * Varchar
 **/
	public $Type = "";
/**
 * MyStoreProductCritere#Value -> String
 * Text
 **/
	public $Value = "";

/**
 * new MyStoreProductCritere()
 * new MyStoreProductCritere(json)
 * new MyStoreProductCritere(array)
 * new MyStoreProductCritere(obj)
 * new MyStoreProductCritere(id)
 * - json (String): Chaine de caractères JSON équivalente à une instance [[MyStoreProductCritere]].
 * - array (Array): Tableau associatif équivalent à une instance [[MyStoreProductCritere]]. 
 * - obj (Object): Objet équivalent à une instance [[MyStoreProductCritere]].
 * - id (int): Numéro d'identifiant de l'instance. Les informations de l'instance seront récupérées depuis la base de données.
 *
 * Cette méthode créée une nouvelle instance de [[MyStoreProductCritere]].
 **/
...
/**
 * MyStoreProductCritere.Initialize() -> void
 *
 * Cette méthode initialise les événements que la classe doit écouter.
 **/	
	public static function Initialize(){
		System::Observe('gateway.exec', array('MyStoreProductCritere', 'exec'));
		System::Observe('gateway.exec.safe', array('MyStoreProductCritere', 'execSafe'));
	}
/**
 * MyStoreProductCritere.Install() -> void
 *
 ...
 **/	
	public static function Install(){
		...
		$request->query = 	"CREATE TABLE `mystore_products_criteres` (
...
/**	
 * MyStoreProductCritere#commit() -> Boolean
 *
 ...
 **/
	public function commit(){
		...
		if ($this->Critere_ID == 0){
			...
			System::Fire('mystore.product.critere:commit', array(&$this, &$request));
			
			if($request->exec('insert')){
				$this->Critere_ID = $request->exec('lastinsert');
				
				System::Fire('mystore.product.critere:commit.complete', array(&$this));
				return true;
			}
...
/**
 * MyStoreProductCritere#delete() -> Boolean
 *
 ...
 **/	
	public function delete(){
		...
		if($request->exec('delete')){
			System::Fire('mystore.product.critere:remove', array(&$this));
			return true;
		}
		return false;
...
/**
 * MyStoreProductCritere.exec(command) -> Number
...
/**
 * MyStoreProductCritere.execSafe(command) -> Number
 * - command (String): Commande à éxécuter.
 *
 * Cette méthode `static` éxécute une commande envoyée par l'interface du logiciel.
 *
...
/**
 * MyStoreProductCritere#exists() -> void
 *
...
/**
 * MyStoreProductCritere.Distinct(field [, word]) -> Array
 *
...
/**
 * MyStoreProductCritere#getTitle() -> String
 *
...
/**
 * MyStoreProductCritere#getColor() -> String
 *
...
/**
 * MyStoreProductCritere#getWidth() -> Number
 *
...
/**
 * MyStoreProductCritere#getHeight() -> Number
 *
...
/**
 * MyStoreProductCritere#getDepth() -> Number
 *
...
/**
 * MyStoreProductCritere#getDepth() -> String
 *
...
/**
 * MyStoreProductCritere#getStock() -> String
 *
 * Cette méthode retourne le stock.
 **/	
	public function getStock(){
		return $this->Value->stock;	
	}
/**
 * MyStoreProductCritere#setStock() -> String
 *
 * Cette méthode assigne le stock.
 **/	
	public function setStock($stock){
		$this->Value->stock = $stock;	
	}
...
/**
 * MyStoreProductCritere#getContent() -> String
 *
...
/**
 * MyStoreProductCritere#getSrc() -> String
 *
...
/**
 * MyStoreProductCritere#getValue() -> String
 *
...
/**
 * MyStoreProductCritere.GetList([clauses [, options]]) -> Array | boolean
 ...
 **/	
	public static function GetList($clauses = '', $options = ''){
		...
		// Evenement
		//
		System::Fire('mystore.product.critere:list', array(&$request, $options));
...
MyStoreProductCritere::Initialize();
