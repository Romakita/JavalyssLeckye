 ...
 **/
	load: function() {
		...
		document.findScript('extends').each(function(s) {
			...
			Import("extends.lang.observer", !Object.isUndefined(window.Observer));
			Import("extends.lang.string", !Object.isUndefined(String.format));
			Import("extends.lang.timer", !Object.isUndefined(window.Timer));
			Import("extends.lang.form", !Object.isUndefined(Extends.Form));
