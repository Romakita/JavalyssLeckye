    ...
    class Plugin extends \ObjectTools{
        ...
        public static function Import($mode = \System::SAFE){
            ...
            if(!empty($_POST['Plugin'])){
                $plugin = new self($_POST['Plugin']);
            }

            if(!empty($_POST['App'])){
                $plugin = new self($_POST['App']);
            }
        ...
        public static function ByFolder($folder){
            return new self(array(self::FOLDER_KEY => $folder));
        }
        /**
         * Plugin.Uri() -> String
         *
        ...
        public function remove(){
            ...
            if($this->Folder == ''){
                $this->Folder = self::ByName($this->Name);
...
namespace {
    class Plugin extends \System\Plugin{}
}