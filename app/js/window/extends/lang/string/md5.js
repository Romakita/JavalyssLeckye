 ...
 */	
	...
	hexHmac: function (k, d) {
		return this.rstr2Hex(this.rstrHmac(this.str2rstr_utf8(k), this.str2rstr_utf8(d)));
	},
	
	b64Hmac: function (k, d) {
		return this.rstr2b64(this.rstrHmac(this.str2rstr_utf8(k), this.str2rstr_utf8(d)));
	},

	anyHmac:function (k, d, e) {
		return this.rstr2Any(this.rstrHmac(this.str2rstr_utf8(k), this.str2rstr_utf8(d)), e);
	},
/*
 * Perform a simple self-test to see if the VM is working
 */	
	vmTest: function () {
		return this.encode("abc").toLowerCase() == "900150983cd24fb0d6963f7d28e17f72";
	},
 ...
 */
	...
	rstrHmac: function (key, data) {
		...
		var hash = this.binl(ipad.concat(this.rstr2binl(data)), 512 + data.length * 8);
 ...
 **/
	md5:function (maxlength){
		maxlength = maxlength || this.length;
		
		var strmd5 = String.MD5.encode(this);
