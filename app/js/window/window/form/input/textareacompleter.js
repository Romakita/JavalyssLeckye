 ...
 *
 * <p class="note">Cette classe est une extension de Window JS. Pour l'inclure vous devez utiliser la méthode Import('window.form.input.textareacompleter').</p>
 *
 **/ 
var TextAreaCompleter = Class.from(InputPopup);

TextAreaCompleter.prototype = {
	className:	'wobject area-input input-recipient area-completer button',
	link:		'',
	parameters:	'',
/**
